        ...
        for it in range(0,iter_proposed_model):
            ...
            if d1_tr_new.count('NO LAUNCHED 2') == 0 and d2_tr_new.count('NO LAUNCHED 2') ==0 and d3_tr_new.count('NO LAUNCHED 2') ==0 and d4_tr_new.count('NO LAUNCHED 2') ==0 and d5_tr_new.count('NO LAUNCHED 2') ==0:
                ...
                for i in indices_5:
                    ...
                    nueva_time_d4.append(0)
                    nueva_time_d5.append(0)
                waiting_drone = [max(nueva_waiting_time_dr1[i],nueva_waiting_time_dr2[i],nueva_waiting_time_dr3[i],nueva_waiting_time_dr4[i],nueva_waiting_time_dr5[i]) for i in range(len(nueva_waiting_time_dr1))]
            ...
            if fact > 0:
                ...
                distance_trucks2 = []
                for i in range(len(road_map)-1):
                    temp2 = abs((points[road_map[i]][0]-points[road_map[i+1]][0])) + abs(points[road_map[i]][1]-points[road_map[i+1]][1])
                    distance_trucks2.append(temp2)
                    if i+1 == len(road_map)-1:
                        k2 = abs((points[road_map[i+1]][0]-points[road_map[0]][0])) + abs(points[road_map[i+1]][1]-points[road_map[0]][1])
